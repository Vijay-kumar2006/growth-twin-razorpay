...
exports.handleMCPRequest = exports.globalMCPEngine = exports.MCPEngine = exports.MCP_TOOLS = exports.GROWTH_QUOTE_STORE = void 0;
...
exports.GROWTH_QUOTE_STORE = new Map();
exports.MCP_TOOLS = [
    {
...
class MCPEngine {
    ...
    async calculateCartQuote(items, couponCode, hasExplicitApproval = false) {
        ...
        exports.GROWTH_QUOTE_STORE.set(cartId, {
            quoteId: cartId,
            cartQuote: quote,
            baseItemIds: baseIds,
    ...
    evaluateSpendPolicy(cartId) {
        ...
        const growthQuote = exports.GROWTH_QUOTE_STORE.get(cartId);
        if (growthQuote) {
            const quoteReq = {
    ...
    evaluateGrowthPolicy(args) {
        ...
        if (args.cart_id && CART_STORE.has(args.cart_id)) {
            ...
            baseValue = cart.subtotal;
            const gq = exports.GROWTH_QUOTE_STORE.get(args.cart_id);
            if (gq) {
    ...
    async simulateTradeoffs(args) {
        ...
        const simulation = (0, revenue_bundle_1.simulateConstraintTradeoffs)(baseItems, availableAddons, {
            budget,
            quantity,
        ...
        if (simulation.hasConflict) {
            audit_logger_1.globalAuditLogger.log('CONSTRAINT_CONFLICT_DETECTED', {
                budget,
                quantity,
                hardConstraints,
                softPreferences,
        ...
        if (args.select_option_id) {
            ...
            if (selectedAlt) {
                ...
                const policyCheck = (0, policy_engine_1.evaluatePolicy)({
                ...
                const stored = exports.GROWTH_QUOTE_STORE.get(newCartQuote.cartId);
                if (stored) {
                    stored.selectedTradeoffOptionId = selectedAlt.optionId;
                    stored.approvalVersion = 1;
                }
                audit_logger_1.globalAuditLogger.log('TRADEOFF_ALTERNATIVE_SELECTED', {
    ...
    async recoverFailedTransaction(args) {
        ...
        const growthQuote = cartId ? exports.GROWTH_QUOTE_STORE.get(cartId) : undefined;
        ...
        audit_logger_1.globalAuditLogger.log('PAYMENT_FAILURE_DETECTED', {
        ...
        const recoveryResult = (0, revenue_bundle_1.generatePaymentRecoveryOptions)({
            quoteId: cart.cartId,
            ...
            productTags,
            hardConstraints: hardConstraints.length > 0 ? hardConstraints : ['jain'],
        }, failureReason, this.growthPolicy.maxUnapprovedOrderValue);
        // Audit Event 2: RECOVERY_OPTIONS_GENERATED
        audit_logger_1.globalAuditLogger.log('RECOVERY_OPTIONS_GENERATED', {
            failedQuoteId: cart.cartId,
        ...
        if (selectOptionId) {
            ...
            if (selectedOpt) {
                ...
                audit_logger_1.globalAuditLogger.log('RECOVERY_OPTION_SELECTED', {
                    failedQuoteId: cart.cartId,
